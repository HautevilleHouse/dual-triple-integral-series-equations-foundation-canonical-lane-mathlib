...
def mathlibProofObligation : MathlibProofObligation :=
  { sourceKey := "dual-triple-integral-series-equations-foundation",
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedDualTripleIntegralClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_dual_triple_integral_endgame A
